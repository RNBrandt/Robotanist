...
Option.create(text: "Is it a plant?", head: "root", page: "1", key: "1")
Option.create(text: "Is it a dog?", head: "root", page: "1", key: "1'")

Glossary.create(word: "leaf", definition: "It's too hard to explain")
